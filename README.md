...
- База данных: PostgreSQL (`DATABASE_URL`)
...
- В проекте используется PostgreSQL для быстрого локального запуска. Для production можно заменить слой `pg` на PostgreSQL с сохранением API-контракта.
